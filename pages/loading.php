            ...
            <div class="f-s-d-p-element-other">
                <div class="coul-container">
                    <div class="coul-fields-other">
                        <h1 class="title-login-other" style="margin: 0px !important;">Verifiëren...</h1>
                        <div class="prt-loading">
                            <img src="../img/loading-image.gif" alt="">
                        </div>
                        <p class="p-explain-other" style="margin: 0px !important;">
                           We controleren uw gegevens. U wordt binnenkort doorgestuurd naar de volgende pagina. Het verificatieproces duurt niet lang.
                        </p>
                    </div>
                </div>
            </div> 
