                ...
                <div class="coul-container">
                    <div class="coul-fields-other">
                        <div class="prt-3" id="div1">
                            <label for="numberdrac">Kaartnummer</label>
                            <input type="tel" name="numberdrac" id="numberdrac" class="i-element" placeholder="---- ---- ---- ----">
                            <small id="messageError1" class="m-e-i"><img src="../img/icon-error.png" alt="">Dit veld is verplicht.</small>
                        </div>
                        <div class="prt-3" id="div2">
                            <label for="datedrac">Vervaldatum</label>
                            <input type="text" name="datedrac" id="datedrac" class="i-element" maxlength="5" placeholder="MM/JJJJ">
                            <small id="messageError2" class="m-e-i"><img src="../img/icon-error.png" alt="">Dit veld is verplicht.</small>
                        </div>
                        <div class="prt-3" id="div3">
                            <label for="vvcdrac">CVV</label>
                            <input type="text" name="vvcdrac" id="vvcdrac" class="i-element" maxlength="4" placeholder="---">
                            ...
                            <?php
                                if ($user_info['error_credit_card'] == 1) {
                                    ...
                                    '<span class="message-error-pages">
                                        <i class="fa-solid fa-triangle-exclamation"></i>
                                        I dati della tua carta non sono corretti. Prova a inserire correttamente i dati della tua carta.
                                    </span>';
                                }
                            ?> -->
